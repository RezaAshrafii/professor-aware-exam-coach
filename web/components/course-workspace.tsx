  ...
  return (
    <main className="workspace-shell">
      <aside className={`workspace-sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <div className="sidebar-footer"><Link href="/"><Icons.ArrowLeft /> بازگشت به همه درس‌ها</Link><div className={`model-chip ${workspace.model_enabled ? "enabled" : "demo"}`}><span />{workspace.model_enabled ? "مدل واقعی فعال" : "حالت آزمایشی"}</div></div>
      </aside>
